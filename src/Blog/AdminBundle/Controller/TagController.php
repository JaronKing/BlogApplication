...
use Blog\AdminBundle\Form\Type\TagType;
...
class TagController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BlogAdminBundle:Tag')->findAll();

        return $this->render('BlogAdminBundle:Tag:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('BlogAdminBundle:Tag:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BlogAdminBundle:Tag')->find($id);
        ...
        return $this->render('BlogAdminBundle:Tag:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('BlogAdminBundle:Tag:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            $entity->setLastUpdated(new \DateTime('now'));
            $em->persist($entity);
            $em->flush();
