...
use Blog\AdminBundle\Entity\Settings;
use Blog\AdminBundle\Form\Type\SettingsType;
...
class SettingsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BlogAdminBundle:Settings')->findAll();

        return $this->render('BlogAdminBundle:Settings:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('BlogAdminBundle:Settings:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BlogAdminBundle:Settings')->find($id);
        ...
        return $this->render('BlogAdminBundle:Settings:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction()
    {
        ...
        $entity = $em->getRepository('BlogAdminBundle:Settings')->find(1);
        ...
        return $this->render('BlogAdminBundle:Settings:edit.html.twig', array(
            'entity'      => $entity,
